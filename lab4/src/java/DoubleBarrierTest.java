...
public class DoubleBarrierTest {
    ...
    private void go(Integer qtd) {
        ...
        String myGradeNode = null;
        try {
            myGradeNode = zk.create("/notas/" + nodeName, score.toString().getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
